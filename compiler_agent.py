...
class CompilerAgent:
    ...
    def get_answer(self, question, sub_tasks):
        instruction = f"""
        You are an Smart Agent. You have access to RAG Agents which provide you with information that helps you answer questions.
        ...
        The final answer should be like a conversational response in a chat.
        
        Respond only a JSON object containing:
        "answer": the final answer you would provide to the user, IDK if you don't know
